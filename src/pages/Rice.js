...
class Rice extends Component 
{
    ...
    render() {
        ...
        const { rices , title_mm , title } = this.state

        const data = rices.filter(p => {
            if(p.title_mm) {
        ...
        const searchMulti = rices.filter(p => {
            if(p.title_mm) {
                return p.title_mm
            } else {
                return p.title
            ...
            <>
                {
                    data.map(rice => {
                        ...
                        return(
                            <div className="col-12 col-lg-6 mb-3 px-2" key={rice.id}>
                                <div
...
export default connect(mapStateToProps , {fetchRices,addProduct})(withRouter(Rice))